    ...
    return (
        <>
            ...
            <SmallText>
                ...
                <Typography><StyledBadge />Get extra 10% off (price inclusive of cashback/coupon) T&C</Typography>
                <Typography><StyledBadge />Flat ₹3,000 Off on HDFC Bank Credit Card EMI Trxns on orders priced between ₹40,000 to ₹49,999 T&C</Typography>
                ...
                <Typography><StyledBadge />EMI starting from ₹440/month T&C</Typography>
            </SmallText>
            <Table>
                <TableBody>
                    <ColumnText>
